...
public class RequestDispatcher {
    ...
    public Response dispatch(ClientHandler client, Request request){
        if (request == null || request.getType() == null) return new Response(request, RequestStatus.INVALID_REQUEST, "Invalid request");
        ...
        return switch (request.getType()) {
            ...
            default -> new Response(request, RequestStatus.INVALID_REQUEST, "Invalid request type");
