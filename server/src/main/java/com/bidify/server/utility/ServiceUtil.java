...
public class ServiceUtil {
    ...
    // Wrapper xử lý request tự động bắt ngoại lệ và chuẩn hóa Response thất bại.
    ...
    // Tải thông tin người dùng từ bộ nhớ đệm (RAM) hoặc database SQLite, đồng thời tính toán số dư bị giữ.
    ...
    // Yêu cầu client phải đang trong một phiên đăng nhập hợp lệ.
